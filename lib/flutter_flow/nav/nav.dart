        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => DriverOnBoardWidget(
            ...
            FFRoute(
              name: 'OneLast',
              path: 'sign-in',
              builder: (context, params) => const OneLastWidget(),
            ),
            FFRoute(
              name: 'AllDrivers',
              path: 'alldrivers',
              ...
              builder: (context, params) => AllDriversWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => DriverRequestWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/655d2da400a648abca600766a89deead.gif',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
