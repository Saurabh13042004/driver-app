...
class _ConfirmWidgetState extends State<ConfirmWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Confirm'});
    ...
    _model.phoneTextController4 ??= TextEditingController();
    _model.phoneFocusNode4 ??= FocusNode();

    _model.phoneTextController5 ??= TextEditingController();
    _model.phoneFocusNode5 ??= FocusNode();
                            ...
                            children: [
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'CONFIRM_arrow_back_rounded_ICN_ON_TAP');
                                    logFirebaseEvent(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model.phoneTextController4,
                                        focusNode: _model.phoneFocusNode4,
                                        autofocus: false,
                                        autofillHints: const [AutofillHints.name],
                                        textCapitalization:
                                            TextCapitalization.words,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model.phoneTextController5,
                                        focusNode: _model.phoneFocusNode5,
                                        autofocus: false,
                                        autofillHints: const [AutofillHints.name],
                                        textCapitalization:
                                            TextCapitalization.words,
